...
function locationChanged() {
    ...
    var type_element_ville = document.getElementById("stage_logement_ville" );
    var type_element_pays = document.getElementById("stage_logement_pays" );
...
google.maps.event.addDomListener(window, 'load', function() {
    initialisationAutocomplete("stage_logement_adresse");
});